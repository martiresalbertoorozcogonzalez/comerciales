   ...
   <section class="bg-white min-h-screen mt-1 mb-1">
    <div class="container"> 
       <div class="py-6 text-center">
           <h2 class="text-6xl text-gray-900 font-bold">Ultimos Furgones</h2>
       </div> 
  
       <div class="md:px-4 md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 space-y-4 md:space-y-0" v-for="cabezal in this.furgones" v-bind:key="cabezal.id">
